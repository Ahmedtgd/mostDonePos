...
>
    <label>
        ...
        >
            <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($option); ?>">
                    <?php echo e($option === 'all' ? __('filament-tables::table.pagination.fields.records_per_page.options.all') : $option); ?>
        ...
        <span class="text-sm font-medium dark:text-white">
            <?php echo e(__('filament-tables::table.pagination.fields.records_per_page.label')); ?>

        </span>
    </label>
</div>
<?php /**PATH /home/k/Documents/spatie/mostDonePos/vendor/filament/tables/src/../resources/views/components/pagination/records-per-page-selector.blade.php ENDPATH**/ ?>